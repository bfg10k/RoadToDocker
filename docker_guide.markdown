...
p.e. `docker run -d -p 9001:9000 -v /var/run/docker.sock:/var/run/docker.sock -v /home/$USER/docker/persistencia/portainer/host:/data portainer/portainer --no-auth`
